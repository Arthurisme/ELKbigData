...
public class Swagger2Config {
	...
	private ApiInfo buildApiInfo() {
		...
		return new ApiInfo("ELK spring data Java API", "ELK Java API description", "1.0.0", "", contact, "", "",
	...
	public Docket swaggerApi() {
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.any())
				.paths(PathSelectors.any()).apis(RequestHandlerSelectors.basePackage("com.paymentcanada")).build()
